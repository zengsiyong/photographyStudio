...
<div id="footer"  class="footer" style="display: block;">
    ...
    <div id="footer_ensure" class="footer_ensure">
            <a href="#nowhere">
            	<img src="${path}/img/site/ensure.png">
            </a>
    </div>
    ...
    <div id="footer_desc" class="footer_desc">
            ...
            <div class="descColumn">
			    ...
			    <a href="#nowhere" ><img src="${path}/img/site/ma.png"></a>
			</div>
    ...
    <img id="cateye" class="cateye" src="${path}/img/site/cateye.png">
    ...
    <div id="copyright" class="copyright">
		...
		<div class="license">
		    ...
		    <div>
		    	<img src="${path}/img/site/copyRight1.jpg">
		    	<img src="${path}/img/site/copyRight2.jpg">
		    </div>
		</div>
    </div>
</div>
